...
const MECHHome = () => {
  ...
  useEffect(() => {
    const fetchHodDetails = async () => {
      try {
        const response = await fetch('http://localhost:4001/api/hod');
  ...
  useEffect(() => {
    const fetchProgrammeDetails = async () => {
      try {
        const response = await fetch("http://localhost:4001/api/programmes");
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchVisionDetails = async () => {
      try {
        const response = await fetch("http://localhost:4001/api/visions");
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchMissionDetails = async () => {
      try {
        const response = await fetch("http://localhost:4001/api/missions");
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchPEOsDetails = async () => {
      try {
        const response = await fetch("http://localhost:4001/api/peos");
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchPOsDetails = async () => {
      try {
        const response = await fetch("http://localhost:4001/api/pos");
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchPSOsDetails = async () => {
      try {
        const response = await fetch("http://localhost:4001/api/psos");
        if (!response.ok) {
