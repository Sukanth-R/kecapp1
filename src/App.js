...
import MECH from "./components/departments/mechdep/mechhome";
import MECHFac from "./components/departments/mechdep/mechfac";
import MECHhigh from "./components/departments/mechdep/mechhigh"
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/departments/mechdep/mechhome" element={<MECH />} />
        <Route path="/departments/mechdep/mechfac" element={<MECHFac/>} />
        <Route path="/departments/mechdep/mechhigh" element={<MECHhigh/>} />
      </Routes>
